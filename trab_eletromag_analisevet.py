...
def produto_escalar():
    ...
    if coord==1:
        print("Defina as componentes do vetor A \n")
        i= inserir_pv_cart()
        print("Defina as componentes do vetor B \n")
        j= inserir_pv_cart()
        print(f'O produto escalar entre esses dois vetores vale {prod_esc(i[0], i[1], i[2], j[0], j[1], j[2])}')
    elif coord==2:
        print("Defina as componentes do vetor A \n")
        i= inserir_pv_cilind()
        print("Defina as componentes do vetor B \n")
